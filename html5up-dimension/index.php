					...
					<div id="main">
						...
						<!-- Contact -->
							<article id="contact">
								...
								<!-- Use Form Methods PDOS here -->
								<form method="post" action="/php-shopping-cart-with-payment-gateway-integration/">
									<div class="fields">
		...
		for (var i = 0; (i < data.length); i++) {
			if (commentId == data[i].parent_comment_id) {
				...
				listReplies(data[i].comment_id, data, reply_list);
						...
						xhttp.open("GET", "http://localhost/php-shopping-cart-with-payment-gateway-integration/index.php?action=remove&id=8", true);
