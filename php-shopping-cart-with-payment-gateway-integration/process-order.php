...
<?php if(!empty($order)) { ?>
    ...
    <input type='hidden'
							name='business' value='redishfish99@gmail.com'> <input
							...
							name='notify_url'
							value='http://localhost/shopping-cart-check-out-flow-with-payment-integration/notify.php'> <input
							type='hidden' name='return'
							value='http://localhost/shopping-cart-check-out-flow-with-payment-integration/response.php'> <input type="hidden"
